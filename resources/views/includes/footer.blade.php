            ...
            <div class="col-lg-10">
              <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                  ...
                  <li>
                  <a title="Jobs" href="https://jobs.ageras.com/jobs">Jobs</a>
                </li>                                                                     
                <li>
    ...
    <div class="col-lg-2">
      <p>
        <img class="logo-footer" src="assets/images/ageras-logo.svg" alt="Logo" />
      </p>
      <p>
        Vesterbrogade 1e<br />
        1620 Copenhagen<br />
    ...
    <div class="col-lg-6">
      <ul>
        <li class="hidden-xs hidden-sm">
          Copyright &copy; Finance Analyst 2012-2019
        </li>
      </ul>
    </div>
