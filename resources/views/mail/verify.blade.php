...
<td class="m_1888394735623576276header" style="font-family: Avenir,Helvetica,sans-serif;box-sizing: border-box;padding: 14px 0 6px 0;text-align: center;background: #171717;">
        <a href="https://searchbysearch.com/" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#bbbfc3;font-size:19px;font-weight:bold;text-decoration:none" target="_blank">
           ...
           <img src="https://searchbysearch.com/frontend-assets/static-images/header/search1.png" class="logo-img">
...
<td style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box">
                                    <button class="m_1888394735623576276button m_1888394735623576276button-blue" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;border-radius:3px;color:#fff;display:inline-block;text-decoration:none;background-color:#3097d1;border-top:10px solid #3097d1;border-right:18px solid #3097d1;border-bottom:10px solid #3097d1;border-left:18px solid #3097d1" target="_blank">Your verrification code is {{$verify_code}}</button>
                                </td>
                            </tr></tbody></table>
</td>
                </tr></tbody></table>
