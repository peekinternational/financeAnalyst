...
<td class="m_1888394735623576276content-cell" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px">
  ...
  <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">Click below to verify your Account.</p>
...
<td style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box">
                                    <a href="{{ url('partner/verify-email?p_id='.$p_id.'&&token='.$token)}}" class="m_1888394735623576276button m_1888394735623576276button-blue" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;border-radius:3px;color:#fff;display:inline-block;text-decoration:none;background-color:#3097d1;border-top:10px solid #3097d1;border-right:18px solid #3097d1;border-bottom:10px solid #3097d1;border-left:18px solid #3097d1" target="_blank">Click to Verify Email</a>
                                </td>
                            </tr></tbody></table>
</td>
                </tr></tbody></table>
